...
import com.maheswara660.filora.common.ui.CustomRadioButton
import androidx.compose.material3.Surface
import com.maheswara660.filora.common.ui.CustomSwitch
...
import com.maheswara660.filora.common.ui.BottomSheetDialog
...
import com.maheswara660.filora.screen.main.tab.files.misc.SortingMethod
        ...
        BottomSheetDialog(
            ...
            Column(
                ...
                val sortOptions = listOf(
                    stringResource(R.string.name_a_z),
                    stringResource(R.string.date_newer),
                    stringResource(R.string.size_smaller),
                    stringResource(R.string.type)
                )
                
                val currentSortIndex = when (sortingMethod) {
                    SortingMethod.SORT_BY_NAME -> 0
                    SortingMethod.SORT_BY_DATE -> 1
                    SortingMethod.SORT_BY_SIZE -> 2
                    SortingMethod.SORT_BY_TYPE -> 3
                    else -> 0
                }

                CustomSegmentedControl(
                    items = sortOptions,
                    defaultSelectedItemIndex = currentSortIndex,
                    onItemSelection = { index ->
                        sortingMethod = when (index) {
                            0 -> SortingMethod.SORT_BY_NAME
                            1 -> SortingMethod.SORT_BY_DATE
                            2 -> SortingMethod.SORT_BY_SIZE
                            3 -> SortingMethod.SORT_BY_TYPE
                            else -> SortingMethod.SORT_BY_NAME
                        }
                    }
                )
