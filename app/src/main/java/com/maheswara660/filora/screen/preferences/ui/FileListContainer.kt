...
fun FileListContainer() {
    ...
    Container(title = stringResource(R.string.file_list)) {
        ...
        PreferenceItem(
            label = stringResource(R.string.show_pop_animation),
            supportingText = emptyString,
            icon = Icons.Rounded.Animation,
            switchState = prefs.showPopAnimation,
            onSwitchChange = { prefs.showPopAnimation = it }
        )
        ...
        PreferenceItem(
            label = stringResource(R.string.enable_category_swiping),
            supportingText = emptyString,
            icon = Icons.Rounded.Swipe,
            switchState = prefs.enableCategorySwiping,
            onSwitchChange = { prefs.enableCategorySwiping = it }
        )
    }
}