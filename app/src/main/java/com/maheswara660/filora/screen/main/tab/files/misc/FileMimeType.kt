...
object FileMimeType {
    ...
    const val filoraPrefsFileType = "filoraprefs"
    ...
    val codeFileType = arrayOf(
        ...
        "scala", "sql", "r", "md", "ini", "yaml", "yml", "dart", "gradle", "kts", "sh"
    )

    @JvmField
    val editableFileType = arrayOf(
        "txt", "text", "log", "dsc", "apt", "rtf", "rtx", "md",
        "csv", "tsv", "ini", "conf", "cfg", "nfo", "json", "xml", "prop", "properties"
    )

    @JvmField
    val imageFileType = arrayOf(
        "png", "jpeg", "jpg", "heic", "heif", "tiff", "gif", "webp", svgFileType, "bmp", "raw",
        "avif", "ico", "psd", "eps", "cr2", "nef", "arw", "dng"
    )

    @JvmField
    val audioFileType = arrayOf(
        "mp3", "4mp", "aup", "ogg", "3ga", "m4b", "wav", "acc",
        "m4a", "flac", "aac", "wma", "aiff", "amr", "midi", "mid", "opus", "mka", "m4r"
    )


    @JvmField
    val apkBundleFileType = arrayOf("apks", "xapk", "apkm", "sapk", "aab")
