...
import com.maheswara660.filora.common.padEnd
import com.maheswara660.filora.common.printFullStackTrace
import com.maheswara660.filora.common.showMsg
import com.maheswara660.filora.common.toJson
import com.maheswara660.filora.screen.main.model.GithubRelease
import com.maheswara660.filora.screen.main.startup.StartupTab
import com.maheswara660.filora.screen.main.startup.StartupTabType
...
class MainActivityManager {
    ...
    fun fetchGithubReleases(
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val url = "https://api.github.com/repos/maheswara660/Filora/releases"
            ...
            try {
                ...
                connection.apply {
                    ...
                    setRequestProperty("User-Agent", "Filora-File-Explorer")
                }
    ...
    fun toggleSearchDialog(show: Boolean) {
        _state.update {
            it.copy(
