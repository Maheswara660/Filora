...
import com.maheswara660.filora.common.icons.Upgrade
import com.maheswara660.filora.screen.main.tab.files.FilesTab
import com.maheswara660.filora.screen.main.tab.home.HomeTab
import com.maheswara660.filora.screen.preferences.PreferencesActivity
    ...
    Row(
        ...
        Box {
            IconButton(
                ...
                if (hasNewUpdate) {
                    Icon(
                        imageVector = FiloraIcons.Upgrade,
...
@Composable
fun MoreOptionsButton(hasNewUpdate: Boolean = false) {
    ...
    Box {
        IconButton(
            ...
            Icon(
                ...
                contentDescription = null,
                tint = if (hasNewUpdate) MaterialTheme.colorScheme.error else MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
        ...
        DropdownMenu(
            ...
            if (mainActivityManager.getActiveTab() is FilesTab) {
                DropdownMenuItem(
                    ...
                    onClick = {
                        (mainActivityManager.getActiveTab() as FilesTab).selectAll()
                        showOptionsMenu = false
                    },
                    leadingIcon = {
                        Icon(
