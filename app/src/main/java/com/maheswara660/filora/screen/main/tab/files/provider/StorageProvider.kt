package com.maheswara660.filora.screen.main.tab.files.provider
...
import com.maheswara660.filora.screen.main.tab.files.holder.RootFileHolder
import com.maheswara660.filora.screen.main.tab.files.holder.StorageDevice
import com.maheswara660.filora.screen.main.tab.files.misc.FileSortingPrefs
...
import com.maheswara660.filora.screen.main.tab.files.misc.StorageDeviceType.EXTERNAL_STORAGE
import com.maheswara660.filora.screen.main.tab.files.misc.StorageDeviceType.INTERNAL_STORAGE
import com.maheswara660.filora.screen.main.tab.files.misc.StorageDeviceType.ROOT
...
object StorageProvider {
    ...
    private fun getExternalStorageDirectories(context: Context): List<Pair<String, File>> {
        ...
        // Method 1: Using getExternalFilesDirs ()
        context.getExternalFilesDirs(null).forEach { directory ->
