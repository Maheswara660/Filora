...
import com.maheswara660.filora.screen.main.startup.StartupTabs
...
import com.maheswara660.filora.screen.preferences.constant.FileItemSize
import com.maheswara660.filora.screen.preferences.constant.ThemePreference
import com.maheswara660.filora.screen.preferences.misc.prefDataStore
import com.maheswara660.filora.screen.preferences.misc.prefMutableState
...
class PreferencesManager {
    ...
    var accentColor by prefMutableState(
        keyName = "accentColor",
        defaultValue = 1,
        getPreferencesKey = { intPreferencesKey(it) }
    )
    ...
    var showPopAnimation by prefMutableState(
        keyName = "showPopAnimation",
        defaultValue = false,
        getPreferencesKey = { booleanPreferencesKey(it) }
    )

    var enableCategorySwiping by prefMutableState(
        keyName = "enableCategorySwiping",
        defaultValue = false,
        getPreferencesKey = { booleanPreferencesKey(it) }
    )
