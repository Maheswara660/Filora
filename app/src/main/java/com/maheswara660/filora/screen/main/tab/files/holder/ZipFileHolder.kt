...
import com.maheswara660.filora.screen.main.tab.files.zip.ZipTree
import com.maheswara660.filora.screen.main.tab.files.zip.model.ZipNode
...
class ZipFileHolder(
    ...
    override fun open(
        ...
        if (file != null) {
            file.open(context, anonymous, skipSupportedExtensions, customMimeType, options)
        } else {
